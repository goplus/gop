...
func TestErrInt128(t *testing.T) {
	codeErrorTest(t, `bar.gop:2:16: cannot use 1<<127 (type untyped int) as type github.com/qiniu/x/gop/ng.Int128 in assignment`, `
var a int128 = 1<<127
`)
...
func TestErrUint128(t *testing.T) {
	codeErrorTest(t, `bar.gop:2:17: cannot use 1<<128 (type untyped int) as type github.com/qiniu/x/gop/ng.Uint128 in assignment`, `
var a uint128 = 1<<128
`)
...
a := uint128(1<<128)
`)
	codeErrorTest(t, `bar.gop:2:17: cannot use -1 (type untyped int) as type github.com/qiniu/x/gop/ng.Uint128 in assignment`, `
var a uint128 = -1
`)
