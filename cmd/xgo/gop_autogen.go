...
//line cmd/xgo/main_cmd.gox:6
func (this *App) MainEntry() {
//line cmd/xgo/main_cmd.gox:6:1
	this.Short("Gop is a tool for managing Go+ source code.")
//line cmd/xgo/main_cmd.gox:7:1
	log.SetFlags(log.Ldefault &^ log.LstdFlags)
//line cmd/xgo/main_cmd.gox:9:1
...
//line cmd/xgo/mod_download_cmd.gox:29:1
		mod1.CmdDownload.Run(mod1.CmdDownload, args)
	})
}
...
//line cmd/xgo/mod_init_cmd.gox:29:1
		mod1.CmdInit.Run(mod1.CmdInit, args)
	})
}
...
//line cmd/xgo/mod_tidy_cmd.gox:25:1
		mod1.CmdTidy.Run(mod1.CmdTidy, args)
	})
}
